...
-- Copiando estrutura do banco de dados para db_helpus
-- CREATE DATABASE IF NOT EXISTS `db_helpus` /*!40100 DEFAULT CHARACTER SET utf8 */;
-- USE `db_helpus`;


-- Copiando estrutura para tabela db_helpus.tb_bairro
CREATE TABLE IF NOT EXISTS `tb_bairro` (
  ...
  KEY `fk_bairro_cidade_idx` (`cd_cidade`),
  CONSTRAINT `fk_bairro_cidade` FOREIGN KEY (`cd_cidade`) REFERENCES `tb_cidade` (`cd_cidade`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_bairro: ~66 rows (aproximadamente)
...
INSERT INTO `tb_bairro` (`cd_bairro`, `nm_bairro`, `cd_cidade`) VALUES
	...
	(5, 'José Menino', 9077),
	(6, 'Pompeia', 9077),
	(7, 'Ponta da Praia', 9077),
	(8, 'Campo Grande', 9077),
	(9, 'Centro', 9077),
	(10, 'Encruzilhada', 9077),
	(11, 'Estuário', 9077),
	(12, 'Jabaquara', 9077),
	(13, 'Macuco', 9077),
	(14, 'Marapé', 9077),
	(15, 'Paquetá', 9077),
	(16, 'Porto Alemoa', 9077),
	(17, 'Porto Macuco', 9077),
	(18, 'Porto Paquetá', 9077),
	(19, 'Porto Ponta da Praia', 9077),
	(20, 'Porto Saboó', 9077),
	(21, 'Porto Valongo', 9077),
	(22, 'Saboó', 9077),
	(23, 'Valongo', 9077),
	(24, 'Vila Belmiro', 9077),
	(25, 'Vila Mathias', 9077),
	(26, 'Vila Nova', 9077),
	(27, 'Vila Rica', 9077),
	(28, 'Monte Serrat', 9077),
	(29, 'Morro Cachoeira', 9077),
	(30, 'Morro Caneleira', 9077),
	(31, 'Morro Chico de Paula', 9077),
	(32, 'Morro da Nova Cintra', 9077),
	(33, 'Morro Embaré', 9077),
	(34, 'Morro Fontana', 9077),
	(35, 'Morro Jabaquara', 9077),
	(36, 'Morro José Menino', 9077),
	(37, 'Morro Marapé', 9077),
	(38, 'Morro Pacheco', 9077),
	(39, 'Morro Penha', 9077),
	(40, 'Morro Saboó', 9077),
	(41, 'Morro Santa Maria', 9077),
	(42, 'Morro Santa Teresinha', 9077),
	(43, 'Morro São Bento', 9077),
	(44, 'Alemoa', 9077),
	(45, 'Areia Branca', 9077),
	(46, 'Bom Retiro', 9077),
	(47, 'Caneleira', 9077),
	(48, 'Chico de Paula', 9077),
	(49, 'Jardim Castelo', 9077),
	(50, 'Jardim Piratininga', 9077),
	(51, 'Jardim São Manoel', 9077),
	(52, 'Outeirinho', 9077),
	(53, 'Rádio Clube', 9077),
	(54, 'Santa Maria', 9077),
	(55, 'São Jorge', 9077),
	...
	(61, 'Ilha Diana', 9077),
	(62, 'Iriri', 9077),
	(63, 'Monte Cabrão', 9077),
	(64, 'Quilombo', 9077),
	(65, 'Sítio das Neves', 9077),
	(66, 'Trindade', 9077);
/*!40000 ALTER TABLE `tb_bairro` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_categoria_instituicao
CREATE TABLE IF NOT EXISTS `tb_categoria_instituicao` (
  `cd_categoria_instituicao` int(11) NOT NULL AUTO_INCREMENT,
  `nm_categoria_instituicao` varchar(30) NOT NULL,
  PRIMARY KEY (`cd_categoria_instituicao`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_categoria_instituicao: ~27 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_categoria_instituicao` DISABLE KEYS */;
INSERT INTO `tb_categoria_instituicao` (`cd_categoria_instituicao`, `nm_categoria_instituicao`) VALUES
	(1, 'Educação'),
	(2, 'Saúde'),
	...
	(7, 'Organização Popular/Participaç'),
	(8, 'Direitos Humanos'),
	(9, 'Povos Indígenas'),
	(10, 'Contra Racismo'),
	(11, 'Relação de Gênero'),
	(12, 'Arte e Cultura'),
	(13, 'Trabalho e Renda'),
	(14, 'Comunicação'),
	(15, 'Questões Urbanas'),
	...
	(24, 'Migrantes ou/e Imigrates'),
	(25, 'População de Rua'),
	(26, 'Ecumenismo'),
	(27, 'Profissionalização');
/*!40000 ALTER TABLE `tb_categoria_instituicao` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_categoria_produto
CREATE TABLE IF NOT EXISTS `tb_categoria_produto` (
  `cd_categoria_produto` int(11) NOT NULL AUTO_INCREMENT,
  `nm_categoria_produto` varchar(60) NOT NULL,
  `sg_categoria_produto` char(2) NOT NULL,
  PRIMARY KEY (`cd_categoria_produto`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_categoria_produto: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_categoria_produto` DISABLE KEYS */;
INSERT INTO `tb_categoria_produto` (`cd_categoria_produto`, `nm_categoria_produto`, `sg_categoria_produto`) VALUES
	(1, 'Roupas e Utensilios', 'RU'),
	(2, 'Produtos Alimenticios', 'PA');
/*!40000 ALTER TABLE `tb_categoria_produto` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_cidade
CREATE TABLE IF NOT EXISTS `tb_cidade` (
  `cd_cidade` int(11) NOT NULL AUTO_INCREMENT,
  `nm_cidade` varchar(45) NOT NULL,
  `cd_estado` int(11) NOT NULL,
  PRIMARY KEY (`cd_cidade`),
  KEY `fk_cidade_estado_idx` (`cd_estado`),
  CONSTRAINT `fk_cidade_estado` FOREIGN KEY (`cd_estado`) REFERENCES `tb_estado` (`cd_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9390 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_cidade: ~9.586 rows (aproximadamente)
...
-- Copiando estrutura para tabela db_helpus.tb_contato_telefone
CREATE TABLE IF NOT EXISTS `tb_contato_telefone` (
  `cd_contato_telefone` int(11) NOT NULL AUTO_INCREMENT,
  `nm_telefone` varchar(15) NOT NULL,
  `cd_usuario` int(11) NOT NULL,
  `cd_instituicao` int(11) DEFAULT NULL,
  PRIMARY KEY (`cd_contato_telefone`),
  KEY `fk_contato_usuario1_idx` (`cd_usuario`),
  CONSTRAINT `fk_contato_usuario1` FOREIGN KEY (`cd_usuario`) REFERENCES `tb_usuario` (`cd_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_contato_telefone: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_contato_telefone` DISABLE KEYS */;
INSERT INTO `tb_contato_telefone` (`cd_contato_telefone`, `nm_telefone`, `cd_usuario`, `cd_instituicao`) VALUES
	(1, '(13) 31133-1131', 4, NULL);
/*!40000 ALTER TABLE `tb_contato_telefone` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_doacao
CREATE TABLE IF NOT EXISTS `tb_doacao` (
  `cd_doacao` int(11) NOT NULL AUTO_INCREMENT,
  `dt_fornecimento_doacao` datetime NOT NULL,
  `ic_ofertado` char(1) NOT NULL,
  `dt_recebimento_doacao` datetime DEFAULT NULL,
  `cd_instituicao` int(11) DEFAULT NULL,
  `cd_usuario` int(11) NOT NULL,
  PRIMARY KEY (`cd_doacao`),
  KEY `cd_doacao_usuario_idx` (`cd_usuario`),
  CONSTRAINT `cd_doacao_usuario` FOREIGN KEY (`cd_usuario`) REFERENCES `tb_usuario` (`cd_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_doacao: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_doacao` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_doacao` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_doador
CREATE TABLE IF NOT EXISTS `tb_doador` (
  `cd_doador` int(11) NOT NULL AUTO_INCREMENT,
  `ic_voluntario` tinyint(4) NOT NULL,
  `cd_instituicao_voluntario` int(11) DEFAULT NULL,
  `cd_usuario` int(11) NOT NULL,
  PRIMARY KEY (`cd_doador`),
  KEY `fk_usuario_doador_idx` (`cd_usuario`),
  CONSTRAINT `fk_usuario_doador` FOREIGN KEY (`cd_usuario`) REFERENCES `tb_usuario` (`cd_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_doador: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_doador` DISABLE KEYS */;
INSERT INTO `tb_doador` (`cd_doador`, `ic_voluntario`, `cd_instituicao_voluntario`, `cd_usuario`) VALUES
	(1, 1, NULL, 4),
	(2, 1, NULL, 5);
/*!40000 ALTER TABLE `tb_doador` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_endereco
CREATE TABLE IF NOT EXISTS `tb_endereco` (
  `cd_endereco` int(11) NOT NULL AUTO_INCREMENT,
  `cd_instituicao` int(11) DEFAULT NULL,
  `cd_cep` varchar(50) NOT NULL,
  `nm_endereco` varchar(200) NOT NULL,
  `nm_numero` varchar(50) NOT NULL,
  `nm_complemento` varchar(100) DEFAULT NULL,
  `cd_bairro` int(11) NOT NULL,
  `cd_usuario` int(11) NOT NULL,
  PRIMARY KEY (`cd_endereco`),
  KEY `fk_endereco_bairro_idx` (`cd_bairro`),
  KEY `fk_endereco_usuario_idx` (`cd_usuario`),
  CONSTRAINT `fk_endereco_bairro` FOREIGN KEY (`cd_bairro`) REFERENCES `tb_bairro` (`cd_bairro`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_endereco_usuario` FOREIGN KEY (`cd_usuario`) REFERENCES `tb_usuario` (`cd_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_endereco: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_endereco` DISABLE KEYS */;
INSERT INTO `tb_endereco` (`cd_endereco`, `cd_instituicao`, `cd_cep`, `nm_endereco`, `nm_numero`, `nm_complemento`, `cd_bairro`, `cd_usuario`) VALUES
	(1, 0, '11086370', 'Rua Julia Antonietta Tepedino Guerra', '19', 'b', 45, 4),
	(2, 0, '11086370', 'Rua Julia Antonietta Tepedino Guerra', '19', 'B', 45, 5);
/*!40000 ALTER TABLE `tb_endereco` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_estado
...
-- Copiando dados para a tabela db_helpus.tb_estado: ~27 rows (aproximadamente)
...
INSERT INTO `tb_estado` (`cd_estado`, `nm_estado`, `sg_estado`) VALUES
	...
	(18, 'Paraná', 'PR'),
	(19, 'Ro de Janero', 'RJ'),
	(20, 'Ro Grande do Norte', 'RN'),
	(21, 'Rorama', 'RR'),
	(22, 'Rondôna', 'RO'),
	(23, 'Ro Grande do Sul', 'RS'),
	(24, 'Santa Catarna', 'SC'),
	(25, 'Sergpe', 'SE'),
	(26, 'São Paulo', 'SP'),
	(27, 'Tocantns', 'TO');
...
-- Copiando estrutura para tabela db_helpus.tb_favorito
CREATE TABLE IF NOT EXISTS `tb_favorito` (
  `cd_favorito` int(11) NOT NULL AUTO_INCREMENT,
  `cd_instituicao` int(11) NOT NULL,
  `cd_doador` int(11) NOT NULL,
  PRIMARY KEY (`cd_favorito`),
  KEY `fk_favorito_usuario_fisico_idx` (`cd_doador`),
  CONSTRAINT `fk_favorito_usuario_fisico` FOREIGN KEY (`cd_doador`) REFERENCES `tb_doador` (`cd_doador`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_favorito: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_favorito` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_favorito` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_img_produto
CREATE TABLE IF NOT EXISTS `tb_img_produto` (
  `cd_img` int(11) NOT NULL AUTO_INCREMENT,
  `nm_endereco` varchar(120) NOT NULL,
  `nm_extensao` char(4) NOT NULL,
  `cd_produto` int(11) NOT NULL,
  PRIMARY KEY (`cd_img`),
  KEY `fk_img_produto_idx` (`cd_produto`),
  CONSTRAINT `fk_img_produto` FOREIGN KEY (`cd_produto`) REFERENCES `tb_produto` (`cd_produto`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_img_produto: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_img_produto` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_img_produto` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_instituicao
CREATE TABLE IF NOT EXISTS `tb_instituicao` (
  `cd_instituicao` int(11) NOT NULL AUTO_INCREMENT,
  `nm_instituicao` varchar(120) NOT NULL,
  `ds_instituicao` varchar(500) DEFAULT NULL,
  `cd_cnpj` varchar(14) NOT NULL,
  `cd_categoria` int(11) NOT NULL,
  `cd_logo` int(11) DEFAULT NULL,
  `cd_bg` int(11) DEFAULT NULL,
  PRIMARY KEY (`cd_instituicao`),
  UNIQUE KEY `UK_CNPJ` (`cd_cnpj`),
  KEY `fk_instituicao_categoria_idx` (`cd_categoria`),
  CONSTRAINT `fk_instituicao_categoria` FOREIGN KEY (`cd_categoria`) REFERENCES `tb_categoria_instituicao` (`cd_categoria_instituicao`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_instituicao: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_instituicao` DISABLE KEYS */;
INSERT INTO `tb_instituicao` (`cd_instituicao`, `nm_instituicao`, `ds_instituicao`, `cd_cnpj`, `cd_categoria`, `cd_logo`, `cd_bg`) VALUES
	(1, 'HelpUs', 'Instituição sem fins lucrativos que tem como objetivo a distribuição de inovações tecnologicas que visam o desenvolvimento social.', '28721745000142', 22, NULL, NULL),
	(2, 'ONG SaindoDoBronze', 'Organização sem fins lucrativos que visa educar jogadores bronze', '22222222222222', 6, NULL, NULL);
/*!40000 ALTER TABLE `tb_instituicao` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_item_instituicao
CREATE TABLE IF NOT EXISTS `tb_item_instituicao` (
  `cd_item_instituicao` int(11) NOT NULL AUTO_INCREMENT,
  `cd_instituicao` int(11) NOT NULL,
  `cd_usuario` int(11) NOT NULL,
  PRIMARY KEY (`cd_item_instituicao`),
  KEY `fk_instituicao_usuario_idx` (`cd_usuario`),
  KEY `fk_usuario_instituicao_idx` (`cd_instituicao`),
  CONSTRAINT `fk_instituicao_usuario` FOREIGN KEY (`cd_usuario`) REFERENCES `tb_usuario` (`cd_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_instituicao` FOREIGN KEY (`cd_instituicao`) REFERENCES `tb_instituicao` (`cd_instituicao`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_item_instituicao: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_item_instituicao` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_item_instituicao` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_midia_instituicao
CREATE TABLE IF NOT EXISTS `tb_midia_instituicao` (
  `cd_midia_instituicao` int(11) NOT NULL AUTO_INCREMENT,
  `nm_endereco` varchar(200) NOT NULL,
  `nm_extensao` char(4) NOT NULL,
  `cd_instituicao` int(11) NOT NULL,
  PRIMARY KEY (`cd_midia_instituicao`),
  KEY `fk_midia_instituicao_idx` (`cd_instituicao`),
  CONSTRAINT `fk_midia_instituicao` FOREIGN KEY (`cd_instituicao`) REFERENCES `tb_instituicao` (`cd_instituicao`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_midia_instituicao: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_midia_instituicao` DISABLE KEYS */;
INSERT INTO `tb_midia_instituicao` (`cd_midia_instituicao`, `nm_endereco`, `nm_extensao`, `cd_instituicao`) VALUES
	(1, 'IMG/NOTIIAS/J4K8n9H3H5J6B3J05nI94j3n4i8', 'PNG', 1),
	(2, 'IMG/NOTIIAS/HuGnYdbUrb87B67Ni98Mi2nmk3h', 'PNG', 1);
/*!40000 ALTER TABLE `tb_midia_instituicao` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_midia_noticia
CREATE TABLE IF NOT EXISTS `tb_midia_noticia` (
  `cd_imgaem_noticia` int(11) NOT NULL AUTO_INCREMENT,
  `nm_endereco` varchar(200) NOT NULL,
  `nm_extensao` char(4) NOT NULL,
  `cd_noticia` int(11) NOT NULL,
  PRIMARY KEY (`cd_imgaem_noticia`),
  KEY `fk_imagem_noticia_idx` (`cd_noticia`),
  CONSTRAINT `fk_imagem_noticia` FOREIGN KEY (`cd_noticia`) REFERENCES `tb_noticia` (`cd_noticia`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_midia_noticia: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_midia_noticia` DISABLE KEYS */;
INSERT INTO `tb_midia_noticia` (`cd_imgaem_noticia`, `nm_endereco`, `nm_extensao`, `cd_noticia`) VALUES
	(1, 'IMG/NOTIIAS/JUINFCANWUNFDAOIENFASLINAIS', 'PNG', 1),
	(2, 'IMG/NOTIIAS/JUINFCANNASUDBBXKUFEBSKUEBG', 'PDF', 1);
/*!40000 ALTER TABLE `tb_midia_noticia` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_noticia
CREATE TABLE IF NOT EXISTS `tb_noticia` (
  `cd_noticia` int(11) NOT NULL AUTO_INCREMENT,
  `nm_titulo_noticia` varchar(60) NOT NULL,
  `nm_subtitulo_noticia` varchar(120) NOT NULL,
  `ds_noticia` varchar(1000) NOT NULL,
  `nm_tags` varchar(30) NOT NULL,
  `nm_local` char(8) NOT NULL,
  `dt_noticia` date NOT NULL,
  `cd_instituicao` int(11) NOT NULL,
  PRIMARY KEY (`cd_noticia`),
  KEY `fk_noticia_instituicao_idx` (`cd_instituicao`),
  CONSTRAINT `fk_noticia_instituicao` FOREIGN KEY (`cd_instituicao`) REFERENCES `tb_instituicao` (`cd_instituicao`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_noticia: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_noticia` DISABLE KEYS */;
INSERT INTO `tb_noticia` (`cd_noticia`, `nm_titulo_noticia`, `nm_subtitulo_noticia`, `ds_noticia`, `nm_tags`, `nm_local`, `dt_noticia`, `cd_instituicao`) VALUES
	(1, 'O Software HelpUs em desenvolvimento!', 'O desenvolvimento do Software HelpUs tem inicio nesta quarta-feira (03/02/2015).', 'Os alunos da ETEC Ruth Cardoso tiveram uma grande ideia, que irá auxiliar o desenvolvimento social dos municipios de Santos e São Vicente. Um software que disponibiliza para instituições oportunidades de divulgação de seu trabalho além de dar um meio de contato entre as instituições e doadores...', '#Desenvolvimento #TCC #ETEC #D', '11086370', '2016-02-03', 1);
/*!40000 ALTER TABLE `tb_noticia` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_produto
CREATE TABLE IF NOT EXISTS `tb_produto` (
  `cd_produto` int(11) NOT NULL AUTO_INCREMENT,
  `cd_categoria` int(11) NOT NULL,
  `nm_produto` varchar(45) NOT NULL,
  `ds_produto` varchar(200) NOT NULL,
  `qt_produto` int(3) NOT NULL,
  `cd_doacao` int(11) NOT NULL,
  PRIMARY KEY (`cd_produto`),
  KEY `fk_categoria_produto_idx` (`cd_categoria`),
  KEY `fk_produto_doacao_idx` (`cd_doacao`),
  CONSTRAINT `fk_categoria_produto` FOREIGN KEY (`cd_categoria`) REFERENCES `tb_categoria_produto` (`cd_categoria_produto`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_produto_doacao` FOREIGN KEY (`cd_doacao`) REFERENCES `tb_doacao` (`cd_doacao`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_produto: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_produto` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_produto` ENABLE KEYS */;


-- Copiando estrutura para tabela db_helpus.tb_usuario
CREATE TABLE IF NOT EXISTS `tb_usuario` (
  ...
  `ic_nivel` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`cd_usuario`),
  UNIQUE KEY `UK_EMAIL` (`nm_email`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela db_helpus.tb_usuario: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_usuario` DISABLE KEYS */;
INSERT INTO `tb_usuario` (`cd_usuario`, `nm_usuario`, `dt_nascimento`, `ic_sexo`, `nm_email`, `cd_senha`, `dt_cadastro`, `dt_ultimo_acesso`, `ic_ativo`, `ic_nivel`) VALUES
	(1, 'Hugo B Rodrigues', '1998-05-09', 'M', 'help.us@outlook.com.br', 'masterKey123', '2016-04-12 14:19:44', '2016-04-12 14:35:26', 1, 2),
	(2, 'Caru Harrison', '1998-01-10', 'F', 'caru@gmail.com', 'masterKey123', '2016-04-08 20:42:34', NULL, 1, 2),
	(3, 'Hugo B Rodrigues', '1998-05-09', 'M', 'hugobarbato@gmail.com', 'masterKey123', '2016-04-12 14:21:13', NULL, 1, 0),
	(4, 'Tester test', '1998-02-02', 'M', 'testes@gmail.com', 'tester12345', '2016-04-19 22:28:41', NULL, 0, 0),
	(5, 'Hugo Jady', '2014-01-25', 'M', 'jadyHug@gmail.com', '123456789', '2016-05-10 16:30:10', NULL, 0, 0);
